...
const outPath = args.out ? path.resolve(args.out) : path.resolve("artifacts/reports/single-eval.report.json");
...
console.log(JSON.stringify({ ok: true, outPath, finalState: report.policy_evaluation.final_state }, null, 2));
