...
### Title
PoRE: Policy-Gated, AI-Assisted Resolution Engine for Prediction Markets

### Problem
Prediction market resolution can be ambiguous due to conflicting sources, timing edges, and rule interpretation.

### Solution
PoRE combines evidence ingestion, dual-agent AI deliberation, policy-as-code risk checks, and CRE-based orchestration.
