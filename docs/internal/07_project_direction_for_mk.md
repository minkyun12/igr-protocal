...
"IGR is a CRE-native, AI-assisted, policy-gated engine that recommends safe market resolution only when evidence quality and consistency thresholds are satisfied."
