...
```text
You are joining the IGR project for Chainlink Convergence 2026.
Read in order:
1) docs/08_IGR_MASTER_PLAYBOOK.md
...
- Save machine-readable outputs under simulation/output/reports/
...
```text
Implement a policy-as-code evaluator for IGR.
