...
> 기준: https://chain.link/hackathon/schedule

## 핵심 마일스톤 (공식)

- **Jan 21–22**: CRE Bootcamp (AI Prediction Markets)
...
- 오피스아워 전날까지 질문 리스트 정리
- 오피스아워에서 “심사 포인트 적합성” 질문 우선
- 마감 24시간 전까지 제출 초안 업로드(예비 제출) 권장
